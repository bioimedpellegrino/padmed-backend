...
async def make_measure(config, config_path, video_path, demographics=None, start_time=2, end_time=42, rotation=None, fps=None, debug_study_cfg_file=None, profile_id="", partner_id=""):
